...
public class ArticleServiceImp implements ArticleService{
    ...
    public Boolean applyFilters(ArticleDTO target, String product, String category, String brand, String price, String freeShipping, String prestige) throws FilterErrorException {
        Boolean result = true;
        try {
            if(product!=null)
            ...
            if(price!=null)
                result = result & target.getPrice().equals(price);
